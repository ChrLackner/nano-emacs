...
(defun nano-theme--basics ()
  ...
  (set-face 'error                                  'nano-face-error)
...
(defun nano-theme--font-lock ()
  ...
  (set-face 'font-lock-doc-face                        'nano-face-salient)
  (set-face 'font-lock-string-face                    'nano-face-popout)
  (set-face 'font-lock-constant-face                 'nano-face-type)
  (set-face 'font-lock-warning-face                   'nano-face-popout)
  (set-face 'font-lock-function-name-face             'nano-face-function)
  (set-face 'font-lock-variable-name-face             'nano-face-variable)
  (set-face 'font-lock-builtin-face                  'nano-face-keyword)
  (set-face 'font-lock-type-face                     'nano-face-type)
  (set-face 'font-lock-keyword-face                  'nano-face-keyword))
...
(defun nano-theme--org ()
  ...
  (with-eval-after-load 'org
    ...
    (set-face 'org-code                                'nano-face-popout)
    ...
    (set-face 'org-level-1                            'nano-face-function)
    (set-face 'org-level-2                            'nano-face-function)
    (set-face 'org-level-3                            'nano-face-function)
    (set-face 'org-level-4                            'nano-face-function)
    (set-face 'org-level-5                            'nano-face-function)
    (set-face 'org-level-6                            'nano-face-function)
    (set-face 'org-level-7                            'nano-face-function)
    (set-face 'org-level-8                            'nano-face-function)
...
(defun nano-theme--company ()
  ...
  (with-eval-after-load 'company
    ...
    ;; (set-face 'company-preview-common '(nano-face-strong nano-face-subtle))
...
(defun nano-theme--shx ()
  "Shx faces"
  (with-eval-after-load 'shx
    (set-face 'comint-highlight-prompt '(nano-face-function))
    )
  )
...
(defun nano-theme--magit ()
  ...
  (with-eval-after-load 'magit
    (set-face 'magit-section-highlight '(nano-face-strong nano-face-subtle))
    (set-face 'magit-diff-context-highlight '(nano-face-strong nano-face-subtle))
    )
  )
